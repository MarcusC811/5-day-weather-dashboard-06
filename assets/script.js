...
const cityWeather = "https://api.openweathermap.org/data/2.5/forecast?q=" + cityInput.value + "&cnt=3&appid=" + APIKey;
const city = cityInput.value;

var cityGeo = "https://api.openweathermap.org/geo/1.0/direct?q=" + cityInput.value+ "&limit=5&appid=" + APIKey;
...
function displayWeather (responseCity, cityLat, cityLog) {
  fetch("https://api.openweathermap.org/data/3.0/onecall?lat=" + cityLat + "&lon=" + cityLog + "&exclude=hourly,minutely,alerts&appid=" + APIKey3 )
    ...
    .then(function (data) {
      ...
      $("#pic0").attr( "src", "httpss://openweathermap.org/img/wn/" + wCode0 + "@2x.png");
      ...
      $("#pic1").attr( "src", "httpss://openweathermap.org/img/wn/" + wCode1 + "@2x.png");
      ...
      $("#pic2").attr( "src", "httpss://openweathermap.org/img/wn/" + wCode2 + "@2x.png");
      ...
      $("#pic3").attr( "src", "httpss://openweathermap.org/img/wn/" + wCode3 + "@2x.png");
      ...
      $("#pic4").attr( "src", "httpss://openweathermap.org/img/wn/" + wCode4 + "@2x.png");
...
// "httpss://openweathermap.org/img/wn/" + wCode0 + "@2x.png";
